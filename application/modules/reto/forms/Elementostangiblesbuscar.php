<?php
class Reto_Form_Elementostangiblesbuscar extends Zend_Form
{
	public function init()
	{
		$AgrupacionDB = Model_AgrupacionMapper::getInstance();
		
		$this->setName('elementostangiblesformbuscar');
		...
		$submit = new Zend_Form_Element_Button('submitelementostangiblesbuscar');
		...
		$clean = new Zend_Form_Element_Button('cleanelementostangiblesbuscar');
		...
		$clean->setAttrib('idButtonSubmit', 'submitelementostangiblesbuscar');
