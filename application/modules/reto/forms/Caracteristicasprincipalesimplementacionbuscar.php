<?php
class Reto_Form_Caracteristicasprincipalesimplementacionbuscar extends Zend_Form
{
	public function init()
	{
		$AgrupacionDB = Model_AgrupacionMapper::getInstance();
		
		$this->setName('caracteristicasprincipalesimplementacionformbuscar');
		...
		$submit = new Zend_Form_Element_Button('submitcaracteristicasprincipalesimplementacionbuscar');
		...
		$clean = new Zend_Form_Element_Button('cleancaracteristicasprincipalesimplementacionbuscar');
		...
		$clean->setAttrib('idButtonSubmit', 'submitcaracteristicasprincipalesimplementacionbuscar');
