<?php
class Reto_Form_Retobuscar extends Zend_Form
{
	public function init()
	{
		$AgrupacionDB = Model_AgrupacionMapper::getInstance();
		
		$this->setName('retoformbuscar');
		...
		$submit = new Zend_Form_Element_Button('submitretobuscar');
		...
		$clean = new Zend_Form_Element_Button('cleanretobuscar');
		...
		$clean->setAttrib('idButtonSubmit', 'submitretobuscar');
