<?php
class Reto_Form_Riesgostecnicosbuscar extends Zend_Form
{
	public function init()
	{
		$AgrupacionDB = Model_AgrupacionMapper::getInstance();
		
		$this->setName('riesgostecnicosformbuscar');
		...
		$submit = new Zend_Form_Element_Button('submitriesgostecnicosbuscar');
		...
		$clean = new Zend_Form_Element_Button('cleanriesgostecnicosbuscar');
		...
		$clean->setAttrib('idButtonSubmit', 'submitriesgostecnicosbuscar');
