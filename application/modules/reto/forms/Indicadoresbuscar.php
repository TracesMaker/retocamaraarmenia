<?php
class Reto_Form_Indicadoresbuscar extends Zend_Form
{
	public function init()
	{
		$AgrupacionDB = Model_AgrupacionMapper::getInstance();
		
		$this->setName('indicadoresformbuscar');
		...
		$submit = new Zend_Form_Element_Button('submitindicadoresbuscar');
		...
		$clean = new Zend_Form_Element_Button('cleanindicadoresbuscar');
		...
		$clean->setAttrib('idButtonSubmit', 'submitindicadoresbuscar');
