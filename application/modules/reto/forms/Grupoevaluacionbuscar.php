<?php
class Reto_Form_Grupoevaluacionbuscar extends Zend_Form
{
	public function init()
	{
		$AgrupacionDB = Model_AgrupacionMapper::getInstance();
		
		$this->setName('grupoevaluacionformbuscar');
		...
		$submit = new Zend_Form_Element_Button('submitgrupoevaluacionbuscar');
		...
		$clean = new Zend_Form_Element_Button('cleangrupoevaluacionbuscar');
		...
		$clean->setAttrib('idButtonSubmit', 'submitgrupoevaluacionbuscar');
