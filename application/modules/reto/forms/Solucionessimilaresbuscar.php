<?php
class Reto_Form_Solucionessimilaresbuscar extends Zend_Form
{
	public function init()
	{
		$AgrupacionDB = Model_AgrupacionMapper::getInstance();
		
		$this->setName('solucionessimilaresformbuscar');
		...
		$submit = new Zend_Form_Element_Button('submitsolucionessimilaresbuscar');
		...
		$clean = new Zend_Form_Element_Button('cleansolucionessimilaresbuscar');
		...
		$clean->setAttrib('idButtonSubmit', 'submitsolucionessimilaresbuscar');
