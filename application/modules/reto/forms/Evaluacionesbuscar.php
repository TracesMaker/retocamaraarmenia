<?php
class Reto_Form_Evaluacionesbuscar extends Zend_Form
{
	public function init()
	{
		$AgrupacionDB = Model_AgrupacionMapper::getInstance();
		
		$this->setName('evaluacionesformbuscar');
		...
		$submit = new Zend_Form_Element_Button('submitevaluacionesbuscar');
		...
		$clean = new Zend_Form_Element_Button('cleanevaluacionesbuscar');
		...
		$clean->setAttrib('idButtonSubmit', 'submitevaluacionesbuscar');
