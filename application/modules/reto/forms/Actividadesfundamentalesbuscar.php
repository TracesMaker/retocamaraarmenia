<?php
class Reto_Form_Actividadesfundamentalesbuscar extends Zend_Form
{
	public function init()
	{
		$AgrupacionDB = Model_AgrupacionMapper::getInstance();
		
		$this->setName('actividadesfundamentalesformbuscar');
		...
		$submit = new Zend_Form_Element_Button('submitactividadesfundamentalesbuscar');
		...
		$clean = new Zend_Form_Element_Button('cleanactividadesfundamentalesbuscar');
		...
		$clean->setAttrib('idButtonSubmit', 'submitactividadesfundamentalesbuscar');
