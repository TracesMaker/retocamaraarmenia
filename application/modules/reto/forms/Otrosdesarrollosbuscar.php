<?php
class Reto_Form_Otrosdesarrollosbuscar extends Zend_Form
{
	public function init()
	{
		$AgrupacionDB = Model_AgrupacionMapper::getInstance();
		
		$this->setName('otrosdesarrollosformbuscar');
		...
		$submit = new Zend_Form_Element_Button('submitotrosdesarrollosbuscar');
		...
		$clean = new Zend_Form_Element_Button('cleanotrosdesarrollosbuscar');
		...
		$clean->setAttrib('idButtonSubmit', 'submitotrosdesarrollosbuscar');
