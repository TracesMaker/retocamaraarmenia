<?php
class Reto_Form_Estadosdelretobuscar extends Zend_Form
{
	public function init()
	{
		$AgrupacionDB = Model_AgrupacionMapper::getInstance();
		
		$this->setName('estadosdelretoformbuscar');
		...
		$submit = new Zend_Form_Element_Button('submitestadosdelretobuscar');
		...
		$clean = new Zend_Form_Element_Button('cleanestadosdelretobuscar');
		...
		$clean->setAttrib('idButtonSubmit', 'submitestadosdelretobuscar');
