<?php
class Reto_Form_Caracteristicasprincipalessolucionbuscar extends Zend_Form
{
	public function init()
	{
		$AgrupacionDB = Model_AgrupacionMapper::getInstance();
		
		$this->setName('caracteristicasprincipalessolucionformbuscar');
		...
		$submit = new Zend_Form_Element_Button('submitcaracteristicasprincipalessolucionbuscar');
		...
		$clean = new Zend_Form_Element_Button('cleancaracteristicasprincipalessolucionbuscar');
		...
		$clean->setAttrib('idButtonSubmit', 'submitcaracteristicasprincipalessolucionbuscar');
