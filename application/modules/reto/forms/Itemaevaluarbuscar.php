<?php
class Reto_Form_Itemaevaluarbuscar extends Zend_Form
{
	public function init()
	{
		$AgrupacionDB = Model_AgrupacionMapper::getInstance();
		
		$this->setName('itemaevaluarformbuscar');
		...
		$submit = new Zend_Form_Element_Button('submititemaevaluarbuscar');
		...
		$clean = new Zend_Form_Element_Button('cleanitemaevaluarbuscar');
		...
		$clean->setAttrib('idButtonSubmit', 'submititemaevaluarbuscar');
