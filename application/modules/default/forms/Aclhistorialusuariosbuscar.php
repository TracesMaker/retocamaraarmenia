<?php
class Form_Aclhistorialusuariosbuscar extends Zend_Form
{
	public function init()
	{
		$AgrupacionDB = Model_AgrupacionMapper::getInstance();
		
		$this->setName('aclhistorialusuariosformbuscar');
		...
		$submit = new Zend_Form_Element_Button('submitaclhistorialusuariosbuscar');
		...
		$clean = new Zend_Form_Element_Button('cleanaclhistorialusuariosbuscar');
		...
		$clean->setAttrib('idButtonSubmit', 'submitaclhistorialusuariosbuscar');
