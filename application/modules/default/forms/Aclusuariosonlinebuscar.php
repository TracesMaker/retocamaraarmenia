<?php
class Form_Aclusuariosonlinebuscar extends Zend_Form
{
	public function init()
	{
		$AgrupacionDB = Model_AgrupacionMapper::getInstance();
		
		$this->setName('aclusuariosonlineformbuscar');
		...
		$submit = new Zend_Form_Element_Button('submitaclusuariosonlinebuscar');
		...
		$clean = new Zend_Form_Element_Button('cleanaclusuariosonlinebuscar');
		...
		$clean->setAttrib('idButtonSubmit', 'submitaclusuariosonlinebuscar');
