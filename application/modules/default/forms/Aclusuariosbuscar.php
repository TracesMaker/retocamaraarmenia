<?php
class Form_Aclusuariosbuscar extends Zend_Form
{
	public function init()
	{
		$AgrupacionDB = Model_AgrupacionMapper::getInstance();
		
		$this->setName('aclusuariosformbuscar');
		...
		$submit = new Zend_Form_Element_Button('submitaclusuariosbuscar');
		...
		$clean = new Zend_Form_Element_Button('cleanaclusuariosbuscar');
		...
		$clean->setAttrib('idButtonSubmit', 'submitaclusuariosbuscar');
