<?php
class Form_Aclpermisosbuscar extends Zend_Form
{
	public function init()
	{
		$AgrupacionDB = Model_AgrupacionMapper::getInstance();
		
		$this->setName('aclpermisosformbuscar');
		...
		$submit = new Zend_Form_Element_Button('submitaclpermisosbuscar');
		...
		$clean = new Zend_Form_Element_Button('cleanaclpermisosbuscar');
		...
		$clean->setAttrib('idButtonSubmit', 'submitaclpermisosbuscar');
