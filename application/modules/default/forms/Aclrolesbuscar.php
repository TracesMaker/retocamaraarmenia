<?php
class Form_Aclrolesbuscar extends Zend_Form
{
	public function init()
	{
		$AgrupacionDB = Model_AgrupacionMapper::getInstance();
		
		$this->setName('aclrolesformbuscar');
		...
		$submit = new Zend_Form_Element_Button('submitaclrolesbuscar');
		...
		$clean = new Zend_Form_Element_Button('cleanaclrolesbuscar');
		...
		$clean->setAttrib('idButtonSubmit', 'submitaclrolesbuscar');
