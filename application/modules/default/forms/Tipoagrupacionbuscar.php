<?php
class Form_Tipoagrupacionbuscar extends Zend_Form
{
	public function init()
	{
		$AgrupacionDB = Model_AgrupacionMapper::getInstance();
		
		$this->setName('tipoagrupacionformbuscar');
		...
		$submit = new Zend_Form_Element_Button('submittipoagrupacionbuscar');
		...
		$clean = new Zend_Form_Element_Button('cleantipoagrupacionbuscar');
		...
		$clean->setAttrib('idButtonSubmit', 'submittipoagrupacionbuscar');
